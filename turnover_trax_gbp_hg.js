...
function turnover_trax_gbp_hg_chart() {
    //var to record any errors while getting data
    var jqxhr_turnover_trax_gbp_hg = $.get('../../datafiles/widget/turnover_trax_gbp_hg.csv', function (data) {
        //set up chart 
        var options = {
            //set chart type
            chart: {
                ...
                renderTo: 'turnover_trax_gbp_hg_container'
            },
            //set title
            title: {
                text: 'TRAX GBP High Grade Turnover (Trailing 12 Months)',
                style: {
                    color: '#4D759E'
                },
                align: 'center'
            ...
            exporting: {
                filename: 'MarketAxess_turnover_trax_gbp_hg',
        ...
        .fail(function (jqxhr_turnover_trax_gbp_hg, exception) {
            ajaxError(jqxhr_turnover_trax_gbp_hg, exception, '#turnover_trax_gbp_hg_container');
    });
}
...
(function () {
    ...
    turnover_trax_gbp_hg_chart();
    $('#turnover_trax_gbp_hg_container').toggle(true);

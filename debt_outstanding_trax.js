...
function debt_outstanding_trax_hghy_chart() {
    //var to catch any issues while getting data 
    var jqxhr_debt_outstanding = $.get('../../datafiles/widget_data/debt_outstanding_trax_hghy.csv', function (data) {
        //set up chart 
        var options = {
            //set chart type
            chart: {    
                type: 'spline',
                renderTo: 'debt_outstanding_trax_hghy_container'
            },
            //set title 
            title: {
                text: 'TRAX Corporate Debt Outstanding',
                style: {
                    color: '#4D759E'
                },
                align: 'center'
            ...
            yAxis: {
                title: {
                    text: 'Corporate Debt Outstanding ( Billions EUR )',
                    style: {
                        color: '#4D759E',
                        fontWeight: 'bold'
                    }
            ...
            exporting: {
                filename: 'MarketAxess_debt_outstanding_trax_hghy',
        ...
        ajaxError(jqxhr_debt_outstanding, exception, '#debt_outstanding_trax_hghy_container');
    });
...
(function () {
    ...
    debt_outstanding_trax_hghy_chart();
})();
...
function avg_trade_size_trax_hghy_chart() {
    //var to catch any issues while getting data 
    var jqxhr_avg_trade_size_trax_hghy = $.get('../../datafiles/widget/avg_trade_size_trax_hghy.csv', function (data) {
        var options = {
            //chart options 
            chart: {
                //set type of graph, where it renders
                type: 'line',
                renderTo: 'avg_trade_size_trax_hghy_container'
            },
            //set title of graph
            title: {
                text: 'TRAX Average Trade Size',
                style: {
                    color: '#4D759E'
                },
                align: 'center'
            ...
            yAxis: {
                title: {
                    text: 'TRAX Average Trade Size ( Thousands EUR )',
                    style: {
                        color: '#4D759E',
                        fontWeight: 'bold'
                    }
            ...
            exporting: {
                filename: 'MarketAxess_avg_trade_size_trax_hghy',
        ...
        .fail(function (jqxhr_avg_trade_size_trax_hghy, exception) {
            ajaxError(jqxhr_avg_trade_size_trax_hghy, exception, '#avg_trade_size_trax_hghy_container');
    });
...
(function () {
    ...
    avg_trade_size_trax_hghy_chart();
    $('#avg_trade_size_trax_hghy_container').toggle(true);

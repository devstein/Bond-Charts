...
function liquidity_concentration_trax_hghy_chart() {
    //var to catch any issues while getting data 
    var jqxhr_liquidity_concentration_trax_hghy = $.get('../../datafiles/widget_data/liquidity_concentration_trax_hghy.csv', function (data) {
        //set up chart 
        ...
        var options = {
            ...
            chart: {
                ...
                renderTo: 'liquidity_concentration_trax_hghy_container'
            },
            //set title
            title: {
                text: 'TRAX Liquidity Concentration',
                style: {
                    color: '#4D759E'
                },
                align: 'center'
            ...
            exporting: {
                filename: 'MarketAxess_liquidity_concentration_trax_hghy',
        ...
        .fail(function (jqxhr_liquidity_concentration_trax_hghy, exception) {
            ajaxError(jqxhr_liquidity_concentration_trax_hghy, exception, '#liquidity_concentration_trax_hghy_container');
    });
}
...
(function () {
    ...
    liquidity_concentration_trax_hghy_chart();
})();